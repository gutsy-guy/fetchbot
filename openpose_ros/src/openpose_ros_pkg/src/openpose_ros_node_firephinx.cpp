...
DEFINE_string(camera_topic,             "/camera_floor_right/driver/color/image_raw",      "Image topic that OpenPose will process.");
...
#define NET_RES_X 320 
#define NET_RES_Y 160  
/*DEFINE_string(resolution,               "1280x720",     "The image resolution (display and output). Use \"-1x-1\" to force the program to use the"
                                                        " default images resolution.");*/
#define OUTPUT_RES_X 424 // Display Resolution Output Width
#define OUTPUT_RES_Y 240  // Display Resolution Output Height
