...
//  g_net_input_size = op::Point(getParam(local_nh, "net_input_width", 656), getParam(local_nh, "net_input_height", 368));
  ...
  g_net_input_size.x = getParam(local_nh, "net_input_width", 320);
  g_net_input_size.y = getParam(local_nh, "net_input_height", 160);

  op::Point<int> net_output_size(getParam(local_nh, "net_output_width", 320), getParam(local_nh, "net_output_height", 160));
  ...
  output_size.x = getParam(local_nh, "output_width", 424);
  output_size.y = getParam(local_nh, "output_height", 240);
